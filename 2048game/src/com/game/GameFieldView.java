...
public class GameFieldView extends JPanel {
    ...
    private static final String format = "%-6s:%10d";
    private Controller controller;

    GameFieldView(Controller controller) {
        setFocusable(true);
    ...
    public void paint(Graphics g) {
        ...
        g.setFont(font);
        g.drawString("Turn back: " + controller.getTurnBackCount(), 15, 470);
        g.drawString(String.format(format, "Score", controller.getScore()), 15, 510);
        g.drawString(String.format(format, "Record", controller.getRecord()), 15, 550);
    }
