...
public class CarGasBurning extends Car {

    public CarGasBurning(String brand, String model, int doorsCount, int wheelsCount, float maxSpeed, String color,
        ...
        this.engines = new Engine[]{new Engine(EngineType.Gas_Burning)};
